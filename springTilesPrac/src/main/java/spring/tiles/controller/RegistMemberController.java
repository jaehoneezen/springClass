...
public class RegistMemberController {
	...
	private void referenceData(Model model) {
		List<Code2> jobCodes = new ArrayList<Code2>();
		jobCodes.add(new Code2("1", "개발자"));
		jobCodes.add(new Code2("2", "UI 개발자"));
		jobCodes.add(new Code2("3", "웹 디자이너"));
		jobCodes.add(new Code2("3", "기획자"));
